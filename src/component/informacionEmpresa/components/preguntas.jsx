...
import { Accordion, AccordionBody, AccordionItem, Container, Row, Col,AccordionHeader } from 'reactstrap';
      ...
      <Row>
        <Col xs="12">
          <Accordion flush open={open} toggle={toggle}>
            <AccordionItem className="accordion-item-PreguntasFrecuentes">
